...
import { fetchTreatment } from "../../../../services/fetchTreatment";
...
const PatientDashboardTreatmentViewUpdate = ({
  patientObj,
  setActiveContent,
  activeContent,
  disableInputs = false,
  ...
  const [, setEnrollmentUuid] = useState("");
  ...
  useQuery(["FETCH_TREATMENT_KEY", recordId], () => fetchTreatment(recordId), {
    onSuccess: (data) => {
      setTreatmentData(data);
      const initialValues = {
        enrollmentUuid: data?.hepatitisEnrollment?.uuid,
        ...data?.hepatitisBTreatmentDto,
        ...data?.hepatitisCTreatmentDto,
        hepatitisBRegimenSwitchDateStarted: formatDate(data?.hepatitisBTreatmentDto?.hepatitisBRegimenSwitchDateStarted),
        hepatitisBPastTreatmentExperienceDateStarted: formatDate(data?.hepatitisBTreatmentDto?.hepatitisBPastTreatmentExperienceDateStarted),
        hepatitisBPastTreatmentExperienceDateCompleted: formatDate(data?.hepatitisBTreatmentDto?.hepatitisBPastTreatmentExperienceDateCompleted),
        hepatitisBNewTreatmentRegimenDateStarted: formatDate(data?.hepatitisBTreatmentDto?.hepatitisBNewTreatmentRegimenDateStarted),
        hepatitisBNewTreatmentRegimenDateCompleted: formatDate(data?.hepatitisBTreatmentDto?.hepatitisBNewTreatmentRegimenDateCompleted),


        hepatitisBRegimenSwitchDateCompleted: formatDate(data?.hepatitisBTreatmentDto?.hepatitisBRegimenSwitchDateCompleted),
        hepatitisCPastTreatmentExperienceDateStarted: formatDate(data?.hepatitisCTreatmentDto?.hepatitisCPastTreatmentExperienceDateStarted),
        hepatitisCPastTreatmentExperienceDateCompleted: formatDate(data?.hepatitisCTreatmentDto?.hepatitisCPastTreatmentExperienceDateCompleted),


        hepatitisCNewTreatmentRegimenDateStarted: formatDate(data?.hepatitisCTreatmentDto?.hepatitisCNewTreatmentRegimenDateStarted),
        hepatitisCNewTreatmentRegimenDateCompleted: formatDate(data?.hepatitisCTreatmentDto?.hepatitisCNewTreatmentRegimenDateCompleted),
        hepatitisCSvr12TestingDateTested: formatDate(data?.hepatitisCTreatmentDto?.hepatitisCSvr12TestingDateTested),

        hepatitisCHcvRetreatmentDateStarted: formatDate(data?.hepatitisCTreatmentDto?.hepatitisCHcvRetreatmentDateStarted),
        hepatitisCRetreatmentSvr12TestingDateTested: formatDate(data?.hepatitisCTreatmentDto?.hepatitisCRetreatmentSvr12TestingDateTested),
  ...
  const { mutate, isLoading } = useMutation({
    ...
    onSuccess: (data) => {
      toast.success("Treatment update successfully");
      setActiveContent((prev) => ({ ...prev, route: "recent-history" }));
    },
    onError: () => {
      toast.error("Treatment update failed");
    },
  });
  ...
  const handleSubmit = (values) => {
    ...
    const payload = {
      enrollmentUuid: treatmentData?.hepatitisEnrollment?.uuid,
      hepatitisBTreatment,
      hepatitisCTreatment,
    };
                        ...
                        <div className="form-group mb-3 col-md-4">
                          ...
                          >
                            ...
                            <select
                              ...
                              value={formik.values?.hepatitisBRegimenSwitchNewRegimen}
                              onChange={formik.handleChange}
                              onBlur={formik.handleBlur}
                              style={{
                                border: "1px solid #014D88",
...
export default PatientDashboardTreatmentViewUpdate;
