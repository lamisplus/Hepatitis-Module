...
import { Accordion, IconButton, Collapse } from '@material-ui/core'
                    ...
                    >
                      <div className="row">
                        ...
                        <div>
                            ...
                            <IconButton
                              onClick={() =>
                                setIsDropdownsOpen((prevState) => {
                                  return {
                                    ...prevState,
                                    liverFunctionTests: !prevState.liverFunctionTests,
                                  };
                                })
                              }
                              aria-expanded={isDropdownsOpen.liverFunctionTests}
                              aria-label="Expand"
                            >
                              <ExpandMoreIcon />
                            </IconButton>
                          ...
                          <div className="card-body">
                            <Collapse in={isDropdownsOpen.liverFunctionTests}>
                              <div
                                className="basic-form"
                                style={{ padding: "0 50px 0 50px" }}
                              >
