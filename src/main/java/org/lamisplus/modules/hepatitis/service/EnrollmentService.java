...
public interface EnrollmentService {
    ...
    ResponseEntity<String> hepatitisFollowup(FollowupDto followupDto);
    ...
    HepatitisFollowup viewHepatitisFollowupByEnrollmentUuid(String enrollmentUuid);
    ...
    FollowupDto updateHepatitisFollowup(Long id, FollowupDto followupDto);
    ...
    HepatitisFollowup viewHepatitisFollowupById(Long id);

    String archiveDiagnosis(Long id);

    String archiveTreatment(Long id);

    String archiveFollowup(Long id);
}
